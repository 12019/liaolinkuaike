...
//	for(;;)
//	{
//		i = com1_gets(Com1RcvBuf, &rcv_len, 5000, 10);
//		if ( i == ok )
//		{
//			com1_send_hex(Com1RcvBuf, rcv_len);
//		}
//		else
//		{
//			com1_send_hex((void *)"n", 1);
//		}
//
//	}
...
//        CardInfo.fare = (INT32U)(pricef * 100.0);
//
//        CardInfo.fare = CardInfo.fare * DevStat.ticket_amount;          //单价*张数
//
//        if ( CardInfo.init_balance < CardInfo.fare )
//        {
//            //余额不足处理
